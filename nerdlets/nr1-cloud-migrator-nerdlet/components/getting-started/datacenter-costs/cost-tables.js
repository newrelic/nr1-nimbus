...
export default class CostTables extends React.PureComponent {
  deleteCost = async (dataFetcher, guid, doc, costType, index) => {
  ...
  render() {
    const { dc, guid, doc, costs, costTotal, selectedDatacenter } = this.props;
          ...
          return (
            <>
              <Header as="h3" style={{ paddingTop: '5px' }}>
                {selectedDatacenter.replace('Datacenter:', '')}: Cost Summary
                Assumptions
              </Header>
